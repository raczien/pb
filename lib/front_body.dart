...
class FrontBodyPainter extends CustomPainter {
  ...
  static final _shapes = [
    ...
    Shape(_data[1], 'face'),
    Shape(_data[2], 'neck'),
    Shape(_data[3], 'neck_right'),
    Shape(_data[4], 'neck_left'),
    Shape(_data[5], 'shoulder_right'),
    Shape(_data[6], 'shoulder_left'),
    Shape(_data[7], 'chest_right'),
    Shape(_data[8], 'chest_left'),
    Shape(_data[9], 'biceps_right'),
    Shape(_data[10], 'biceps_left'),
    Shape(_data[11], 'core_left'),
    Shape(_data[12], 'core_right'),
    Shape(_data[13], 'forearm_left'),
    Shape(_data[14], 'forearm_right'),
    Shape(_data[15], 'core_1'),
    Shape(_data[16], 'core_2'),
    Shape(_data[17], 'core_3'),
    Shape(_data[18], 'core_4'),
    Shape(_data[19], 'core_5'),
    Shape(_data[20], 'core_6'),
    Shape(_data[21], 'core_7'),
    Shape(_data[22], 'core_8'),
    Shape(_data[23], 'thigh_1'),
    Shape(_data[24], 'thigh_2'),
    Shape(_data[25], 'thigh_3'),
    Shape(_data[26], 'thigh_4'),
    Shape(_data[27], 'thigh_5'),
    Shape(_data[28], 'thigh_6'),
    Shape(_data[29], 'thigh_7'),
    Shape(_data[30], 'thigh_8'),
    Shape(_data[31], 'thigh_9'),
    Shape(_data[32], 'thigh_10'),
    Shape(_data[33], 'hand_left'),
    Shape(_data[34], 'hand_right'),
    Shape(_data[35], 'knee_right'),
    Shape(_data[36], 'knee_left'),
    Shape(_data[37], 'shin_1'),
    Shape(_data[38], 'shin_2'),
    Shape(_data[39], 'shin_3'),
    Shape(_data[40], 'shin_4'),
    Shape(_data[41], 'foot_left'),
    Shape(_data[42], 'foot_right'),
  ];
  ...
  static void addGroup() {
    _selectedMuscles.add(_shapes[15]);
    _selectedMuscles.add(_shapes[16]);
    _selectedMuscles.add(_shapes[17]);
    _selectedMuscles.add(_shapes[18]);
    _selectedMuscles.add(_shapes[19]);
    _selectedMuscles.add(_shapes[20]);
    _selectedMuscles.add(_shapes[21]);
    _selectedMuscles.add(_shapes[22]);
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var shape in _shapes) {
      if (lastSize == size &&
          _notifier.value != Offset(0.0, 0.0) &&
          lastNotifier != _notifier.value) {
        if (shape._transformedPath.contains(_notifier.value)) {
